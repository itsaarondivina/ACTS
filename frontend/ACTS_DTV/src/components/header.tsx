  ...
  return (
    <AppBar position="fixed" sx={{ backgroundColor: '#222', borderColor: '#080808'}}>
      <Toolbar>
        ...
        >
          <Link to="/" style={{ color: 'inherit', textDecoration: 'none', fontSize: '40px', fontWeight: 'bold' }}>
            <span className="logo-style">A</span><span style={{ color: '#00a8e0' }}>gent </span>
            <span className="logo-style">C</span><span style={{ color: '#00a8e0' }}>all </span>
            <span className="logo-style">T</span><span style={{ color: '#00a8e0' }}>racker </span>
            <span className="logo-style">S</span><span style={{ color: '#00a8e0' }}>ystem</span>
          </Link>
        </Typography>
        ...
        >
          ...
          <MenuItem component={Link} to="/login" onClick={handleChoicesClose}>
